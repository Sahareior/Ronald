...
const ActiveUsers = () => {
  return (
    <div className="flex flex-col items-center justify-center h-[80vh] bg-[#F7F5EF]">
      <h2 className="text-3xl font-bold text-[#333] mb-1">Need Help?</h2>
      <p className="text-gray-600 mb-8">Chat with us or request a return below.</p>
      ...
      <div className=" rounded-xl shadow-lg flex md:flex-row flex-col items-start gap-6 p-8 bg-[#EAE7E1] w-full max-w-4xl">
        ...
        <div className="flex-1 space-y-5">
          ...
          <Button type="primary" className="bg-[#CBA135] hover:bg-[#b8972b] text-white mt-4">
            Start Live Chat
          </Button>
        </div>
