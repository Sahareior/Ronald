    ...
    <div>
      ...
      <div className="p-6 bg-white space-y-6 shadow-sm rounded-b-md">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <label className="block mb-1 popbold text-[14px] text-gray-700">Edit Product Name</label>
            <input
              name="name"
              value={formData.name}
...
<div className="relative">
  <label className="block mb-1 popbold text-[14px] text-gray-700">Edit Category</label>
  <div 
  ...
  {showCategoryDropdown && (
    <div className="absolute z-10 mt-1 w-full bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-y-auto">
      {FURNITURE_CATEGORIES.map(category => (
        ...
        {/* Descriptions */}
        <div>
          <label className="block mb-2 popbold text-[14px] text-gray-700">Edit Short Description</label>
          <textarea
        ...
        <div>
          <label className="block mb-2 popbold text-[14px] text-gray-700">Edit Full Description</label>
          <textarea
        ...
        <div>
          <div className="grid md:grid-cols-3 gap-4">
            <div>
              <label className="block mb-1 popbold text-[14px] text-gray-700">Edit Product Price</label>
              <input
                name="price1"
            ...
            <div>
              <label className="block mb-1 popbold text-[14px] text-gray-700">Edit Discount Price</label>
              <input
                name="price2"
            ...
            <div>
              <label className="block mb-1 popbold text-[14px] text-gray-700">Edit Commission Price</label>
              <input
                name="price3"
        ...
        <div>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label className="block mb-1 popbold text-[14px] text-gray-700">Edit SKU</label>
              <input
                name="sku"
                value={formData.sku}
                onChange={handleInputChange}
            ...
            <div>
              <label className="block mb-1 popbold text-[14px] text-gray-700">Edit Stock Quantity *</label>
              <input
                name="stockQuantity"
            ...
            {/* Color Selection */}
            <div className="relative">
              <label className="block mb-1 popbold text-[14px] text-gray-700">Edit Color</label>
              <div 
                className="w-full border border-[#D1D5DB] bg-[#EAE7E1] rounded-md px-4 py-2 focus:outline-none cursor-pointer"
            ...
            {/* Size Selection */}
            <div className="relative">
              <label className="block mb-1 popbold text-[14px] text-gray-700">Edit Size</label>
              <div 
                className="w-full border border-[#D1D5DB] bg-[#EAE7E1] rounded-md px-4 py-2 focus:outline-none cursor-pointer"
        ...
        <p className='popbold text-[20px] mt-5'>Edit Delivery Options</p>
        <hr />
          ...
          <div className="gap-4">
            ...
            <div className="md:col-span-3 mt-5">
              <label className="block mb-1 text-sm font-semibold text-gray-700">
               Edit Estimated Delivery Time (days)
              </label>
              <input
                name="deliveryTime"
                type='number'
        ...
        <div className="pt-2">
          <div className="space-y-4">
            <div>
              <label className="block mb-1 text-sm font-semibold text-gray-700">Edit SEO Title</label>
              <input
                name="seoTitle"
            ...
            <div>
              <label className="block mb-1 text-sm font-semibold text-gray-700">Edit Meta Description</label>
              <textarea
