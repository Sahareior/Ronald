...
<div className='bg-[#FAF8F2] '>
        <div className="p-6 my-9 w-full px-40 mx-auto rounded-lg">
      <div className="flex flex-col md:flex-row  gap-9">
        {/* Product Image */}
        <div className="flex-1">
          <img
            className="w-full  mx-auto h-[600px] object-cover md:mx-0 rounded-lg"
        ...
        <div className="flex-1 space-y-11">
          <div>
            <h2 className="text-3xl font-bold text-gray-800">Luxury Velvet Sectional Sofa</h2>
            <h3 className="text-lg text-gray-500 mb-1">by Elegant Furniture Co.</h3>
          ...
          <h3 className="text-4xl text-[#CBA135] font-bold">$3000.00</h3>

          {/* Color Options */}
          <div>
            <h4 className="text-md font-medium mb-1 text-gray-700">Color</h4>
          ...
          {/* Size Options */}
          <div>
            <h4 className="text-md font-medium mb-1 text-gray-700">Size</h4>
          ...
          {/* Stock & Wishlist */}
          <div className="flex justify-between max-w-[24rem] items-center">
            <div className='flex gap-2'>
                            <Tag color="green">In Stock</Tag>
            <p className="text-sm text-gray-400">* Only 3 left</p>
            </div>
            <p className="text-sm text-gray-500 cursor-pointer hover:underline">Move to Wishlist</p>
          </div>
          

          {/* Action Buttons */}
          <div className="flex flex-wrap gap-4 mt-6">
            <Button type="primary" className="bg-yellow-600 px-20 h-[56px] hover:bg-yellow-700">
              Add to Cart
            </Button>
            <Button className="border-yellow-600 px-20 h-[56px] text-white bg-black">
              Buy Now
            </Button>
          </div>
        </div>
       ...
       <div className='mt-24'>
        {/* description */}
       <div className=''>
         <p className='border-b-2 text-[#CBA135] border-[#CBA135] w-24'>Description</p>
         <div className='w-full -mt-1 shadow-md h-1' />
       </div>
       <div className='p-9 mt-7 bg-white rounded-2xl shadow-xl'>
        <h2 className='text-[24px] font-bold mb-5'>Product Description</h2>
       ...
       <div className=''>
         <div className='flex justify-between'>
            <p className='border-b-2 text-[#CBA135] border-[#CBA135] w-24'>Specifications</p>
            <p className=' w-24 text-[#CBA135] flex gap-2 justify-center items-center font-semibold'>Download <FaLongArrowAltDown size={18} /></p>
         </div>
         <div className='w-full -mt-1 shadow-md h-1' />
       </div>
       {/* ......................... */}
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4  pt-5">
    {productSpecs.map((item, index) => (
      <div key={index} className="flex justify-between  border-b-2 items-baseline py-2.5">
        <span className="font-medium text-gray-600 text-sm md:text-base">{item.label}</span>
        <span className="text-gray-700 text-sm md:text-base text-right max-w-[60%]">
          {item.value}
        </span>
      </div>
    ))}
...
<div className='mt-24'>
         ...
         <div className='flex justify-between'>
            ...
            <p className='text-[#CBA135] font-semibold w-24'>View all</p>
         </div>
         <div className='w-full -mt-1 shadow-md h-1' />
       </div>
       {/* reviews */}
<div className='grid grid-cols-3 gap-7 mt-10 justify-items-center'>
   ...
   <div>
    <div className=' px-40 mt-24'>
                       <div className=''>
         <div className='flex justify-between'>
            <p className='border-b-2 text-[#CBA135] border-[#CBA135] w-36'>You also bought</p>
            <p className='text-[#CBA135] font-semibold w-24'>View all</p>
         </div>
         <div className='w-full -mt-1 shadow-md h-1' />
       </div>
    ...
    <div className=' px-40 mt-24'>
                       <div className=''>
         <div className='flex justify-between'>
            <p className='border-b-2 text-[#CBA135] border-[#CBA135] w-36'>Compare Similart</p>
