  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-2/4 md:left-28 left-6 -translate-y-1/2 text-white max-w-3xl space-y-16">
        <h2 className="text-3xl md:text-5xl font-bold leading-tight drop-shadow">
        ...
        <Button
          className="bg-[#CBA135] hover:bg-[#b8962e] py-6  text-white font-medium px-9 rounded-md shadow-lg transition-all"
          type="primary"
        >
          Apply to Sell
        </Button>
