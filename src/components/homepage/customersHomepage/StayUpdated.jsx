...
const StayUpdated = () => {
    return (
        <div className='bg-[#666666] py-12 px-4 text-white'>
            <h2 className='text-[30px] text-center font-semibold mb-2'>Stay Updated</h2>
            ...
            <div className='flex justify-center items-center max-w-xl mx-auto'>
                ...
                />
                <Button className='px-6 rounded-none rounded-r-md bg-[#CBA135] text-white h-[48px] border-none'>
                    Subscribe
                </Button>
            </div>
        </div>
